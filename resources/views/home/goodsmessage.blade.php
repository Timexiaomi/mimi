            ...
            <div class="container">
                <div class="row">
                    <div class="span14 goods-detail-comment-list">
                        ...
                        <ul class="comment-box-list" id="J_supComment">
                         <li class="item-rainbow-8" data-id="131808096">
                          ...
                          <div class="user-image"> <img src="" alt="评价人头像"> </div>

                           <div class="user-emoj"> 超爱<i class="iconfont"></i> </div>
                            <div class="user-name-info"> <span class="user-name"> 734214762 </span> <span class="user-time">2016年1月10日</span> <span class="pro-info">透明</span> </div>
                         ...
                         <dt class="user-comment-content J_commentContent"> <p class="content-detail">  很好哦！最近比较忙～评价的有点晚 </p>  </dt>

                          <dd class="user-comment-self-input"> <div class="input-block"> <input type="text" placeholder="回复楼主" class="J_commentAnswerInput"> <a href="javascript:void(0);" class="btn  answer-btn J_commentAnswerBtn" data-commentid="131808096">回复</a> </div> </dd>

                          <dd class="user-comment-answer"> <img class="self-image" src="" alt=""> <p>都没有人陪人家。O(∩_∩)O，感谢您对小米的支持。<span class="official-name">官方回复</span> <a href="javascript:void(0);" class="J_csLike " data-commentid="131808096"> <i class="iconfont"></i>赞客服&nbsp;  <span class="amount"> 31</span>  </a></p> </dd>

                           <dd class="user-comment-answer"> <img class="self-image" src="" alt="回复人头像"> <p>会不会留指纹，容易脏吗- <span class="answer-user-name">航航</span> </p> </dd>
                    ...
                    <div class="span6 goods-detail-comment-timeline">
                        ...
                        <li class="purple timelineunit J_commentContent" data-id="138389063"> <h4 class="line-time">昨天 09:42</h4> <p class="line-content"> <a href="http://order.mi.com/comment/commentDetail/comment_id/138389063" target="_blank"> 第一次自己贴膜！不错！手机看起来像新的一样 </a> </p>  <div class="line-foot"> <div class="line-left">来自于 蒙懂</div> <div class="line-right J_hasHelp " data-commentid="138389063"> <i class="iconfont"></i>有帮助&nbsp;&nbsp;<span class="amount"></span> </div> </div> <div class="line-dot item-rainbow-3"></div> </li>
