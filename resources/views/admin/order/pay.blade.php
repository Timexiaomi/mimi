    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><button class="btn btn-block btn-primary" data-toggle="modal" data-target="#myadd">添加支付方式</button></h3>
			...
			<!-- 做添加的模态框 -->
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <input id='tianjia' class="form-control input-lg" placeholder="请输入支付方式" type="text">
			      </div>
            ...
            @foreach($list as $li)
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			        <h4 class="modal-title">修改支付方式</h4>
			      </div>
			      <div class="modal-body">
